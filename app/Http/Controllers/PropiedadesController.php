...
use App\Http\Requests\PropiedadValidationRequest;
...
use Carbon\Carbon;
use Database\Seeders\FormasEntregaSeeder;
use Illuminate\Http\Request;
use Illuminate\Support\Arr;

class PropiedadesController extends Controller
{
    private $tipo = 'propiedades';
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(PropiedadValidationRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(PropiedadValidationRequest $request, $id)
    {
    ...
    public function createOrUpdate($request, $id = null){
        ...
        $inmueble = is_null($id) ? new Inmueble() : Inmueble::findOrFail($id);
        $inmueble = mapModel($inmueble, $request->except(['servicios', 'generales', 'exteriores', 'amenidades', 'restricciones', 'idx', 'imagenes', 'antiguedad_fecha']));
