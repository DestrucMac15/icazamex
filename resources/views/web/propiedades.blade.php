            ...
            <form action="" id="form_filtros" method="GET">
                ...
                <div class="sidebar-header">
                    ...
                    @foreach($_GET as $clave => $valor)
                        ...
                        @if($clave == 'recamaras')
                            <div class="chip" data-nombre="{{$clave}}">
                                {{$valor}} recamaras(s) <i class="fas fa-times eliminar_filtro"></i>
                            </div>
                        @endif
                    @endforeach
                </div>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-breadcrumb navbar-dark f-400">
                                <li class="breadcrumb-item"><a class="color-verde" href="{{route('web.propiedades')}}">INICIO</a></li>
                                @if(isset($tipo))
                        ...
                        @if(isset($tipo) && $tipo == 'desarrollos')
                            <h3 class="text-center my-5">El <b class="text-success">Desarrollo</b> que buscas<br>están con nosotros</h3>
                        @elseif(isset($tipo) && $tipo == 'propiedades')
                            <h3 class="text-center my-5">Consulta las <b class="text-success">Propiedades</b> que<br> tenemos para ti</h3>
                        @endif
                    </div>
                    <div class="col-md-12">
                                ...
                                <div class="col-12 col-lg-6 col-xl-4 mb-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="col-12 px-0 py-2 btn-gradient-blue white-text mb-3">
                                                <div class="firstPriceContainer pl-3">
                                                    <h5 class="mb-0"> $ <span>{{$propiedad->precio_venta}}</span> MX</h5>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <!-- Title -->
                                        ...
                                        <div class="card-footer white-text text-center mt-4">
                                            <div class="row">
                                                <div class="col-4">
                                                    <i class="fas fa-bed"></i> <span>{{$propiedad->recamaras}} Recamaras</span>
                                                </div>
                                                <div class="col-4">
